...
<svg width="400.0" height="400.0" xmlns="http://www.w3.org/2000/svg">
  ...
  void initState() {
    super.initState();
    // Parse SVG to extract vertices and edges
...
class StaticSvgPathWidget extends StatefulWidget {
  const StaticSvgPathWidget({super.key});

  @override
  _StaticSvgPathWidgetState createState() => _StaticSvgPathWidgetState();
}

class _StaticSvgPathWidgetState extends State<StaticSvgPathWidget> {
  // Track clicked vertices
  List<String> clickedVertices = [];
...
<svg width="400.0" height="400.0" xmlns="http://www.w3.org/2000/svg">
  ...
  // Store vertex positions
  final Map<String, Offset> vertexPositions = {
    'A': const Offset(218.74438339313542, 338.1165745765152),
    'B': const Offset(216.77128932398864, 201.79371161728358),
    'C': const Offset(325.3811492211133, 192.28698564775823),
    'D': const Offset(56.950669723100035, 204.03586396858674),
  };
  ...
  String findPath(String start, String end) {
    ...
    while (queue.isNotEmpty) {
      ...
      Log.e('edges.length  ${edges.length}');
